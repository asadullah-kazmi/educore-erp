...
WHERE TeacherID = @TeacherID;";
        ...
        private static void AddTeacherParameters(SqlCommand command, Teacher teacher)
        {
            ...
            command.Parameters.Add(new SqlParameter("@CnicFrontImageData", System.Data.SqlDbType.VarBinary, -1) { Value = (object)teacher.CnicFrontImageData ?? DBNull.Value });
            ...
            command.Parameters.Add(new SqlParameter("@CnicBackImageData", System.Data.SqlDbType.VarBinary, -1) { Value = (object)teacher.CnicBackImageData ?? DBNull.Value });
            ...
            command.Parameters.Add(new SqlParameter("@EducationalDocumentsData", System.Data.SqlDbType.VarBinary, -1) { Value = (object)teacher.EducationalDocumentsData ?? DBNull.Value });
            ...
            command.Parameters.Add(new SqlParameter("@CertificatesData", System.Data.SqlDbType.VarBinary, -1) { Value = (object)teacher.CertificatesData ?? DBNull.Value });
